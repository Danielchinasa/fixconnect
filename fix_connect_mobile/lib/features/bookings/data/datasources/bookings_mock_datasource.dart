...
class BookingsMockDatasource {
  ...
  static List<BookingModel> getBookings() => [
    BookingModel(
      ...
      service: 'Plumbing',
      serviceDescription: 'Pipe repair needed near bathroom sink.',
    ...
    BookingModel(
      ...
      service: 'Electrical',
      serviceDescription: 'Rewiring of living room and kitchen.',
    ...
    BookingModel(
      ...
      artisanBadgeColor: AppColors.primaryLight,
      service: 'Cleaning',
      serviceDescription: 'Deep clean of 3-bedroom apartment.',
    ...
    BookingModel(
      ...
      service: 'Carpentry',
      serviceDescription: 'Assembly of new bedroom furniture set.',
    ...
    BookingModel(
      ...
      artisanBadgeColor: AppColors.secondary,
      service: 'Painting',
      serviceDescription: 'Interior painting of 2-bedroom flat.',
