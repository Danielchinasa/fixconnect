...
/// Hero header for ServiceDetailPage — uses the app's primary colour.
class ServiceHeroHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Single-hue depth: slightly darkened at top, pure primary at bottom.
    final heroTop = Color.lerp(primary, Colors.black, 0.28)!;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, color: Colors.black87, size: 11),
          const SizedBox(width: 4),
          Text(
            label,
            style: AppTextStyles.bodySmallMedium(color: Colors.black87),
          ),
        ],
      ),
    );
